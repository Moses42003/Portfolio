...
export function AdminSkillsPage() {
  ...
  return (
    <section className="pb-20 lg:pb-0">
      <AdminPageHeader title="Skills" description="CRUD-ready skill catalog with categories, proficiency, years, featured flags, and sort order." action={<Button icon={<Plus className="size-4" />}>Add Skill</Button>} />
